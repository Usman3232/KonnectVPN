...
class NetworkTestScreen extends StatelessWidget {
              ...
              child: SizedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _columnInfo(title: "Language", data: "English"),
                      _columnInfo(
                      ...
                      _columnInfo(title: "User IP", data: "176.237.51.251"),
                      _columnInfo(title: "Download Speed", data: "NaN Kb/s"),
                      Spacing.y(2),
                    ],
                  ),
                ),
  ...
  Widget _columnInfo({String title = "title", data = "data"}) {
    return Padding(
